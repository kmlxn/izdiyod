    ...
    $.fn.extend({
        quake: function (options) {
            var settings = $.extend({
                ...
                captionsSetup: null,
                onSliderInitialized: null,
                onBeforeCaptionAnimate: null,
                onAfterCaptionAnimate: null,
                onBeforeSlideAnimate: null,
                onAfterSlideAnimate: null
            }, options);
            ...
            return this.each(function () {
                ...
                $(window).load(function () {
                    ...
                    if (settings.onSliderInitialized != null)
                        settings.onSliderInitialized();
                    runAnimation();
                    start();
                });
                function setup() {
                ...
                function addNavigationControls() {
                    ...
                    $(images).each(function (index, image) {
                        nav.append($('<a/>').attr('href', '#').attr('rel', index).addClass('quake-nav-control').html((index + 1)));
                    });
                ...
                function animateCaption() {
                    if (settings.onBeforeCaptionAnimate != null)
                        settings.onBeforeCaptionAnimate();
                    ...
                    setTimeout(function () {
                        if (settings.onAfterCaptionAnimate != null)
                            settings.onAfterCaptionAnimate();
                ...
                function runAnimation() {
                    if (!isAnimating) {
                        ...
                        if (settings.onBeforeSlideAnimate != null)
                            settings.onBeforeSlideAnimate();
                        ...
                        if (settings.onAfterSlideAnimate != null)
                            settings.onAfterSlideAnimate();
                    }
